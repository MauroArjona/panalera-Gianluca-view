...
export const MOCK_HERO_SLIDES = [
  {
    ...
    subtitle: 'Panales y cuidado',
    description: 'Productos practicos para acompanar cada etapa del bebe.',
  ...
  },
  {
    ...
    description: 'Elegi articulos de higiene, limpieza y cuidado para tu familia.',
